            ...
            <div className="flex justify-start">
              ...
              <div className="flex flex-col mr-10">
                <div className="flex justify-between">
                  ...
                  <div className="ml-2">{record.totalAbsents}</div>
                </div>
                <div className="flex justify-between">
                  <div className="font-bold">Half Day : </div>
                  <div className="ml-2">{record.totalHalfDays}</div>
                </div>
              </div>
            </div>
          ),
...
const CalculatePayroll = () => {
  ...
  const OnSubmit = async () => {
    ...
    const dataArray = payslips.map((i) => ({
      ...
      totalFullDays: i.totalFullDays,
      totalHalfDays: i.totalHalfDays,
      totalAbsents: i.totalAbsents,
      perDaySalary: i.perDaySalary,
      bonus: i.bonus,
